...
move_grid[0,1] = [256,160,100004];
move_grid[0,2] = [480,160,100005];
move_grid[0,3] = [704,160,100006];
move_grid[0,4] = [928,160,100002];

move_grid[1,0] = [64,512,0];
move_grid[1,1] = [256,512,100007];
move_grid[1,2] = [480,512,100008];
move_grid[1,3] = [704,512,100009];
move_grid[1,4] = [928,512,100003];
