...
draw_text_ext(200, 112, "PRESS SPACE TO PICK PUMPKINS BEFORE THEY POP!", 12, 100);

// basket
draw_rectangle(265, y_box_top, 375, y_box_bottom, true);
draw_text(320, y_box_top + 12, "BASKETS");
draw_text_ext(320, 148, "PRESS SPACE TO DROP PUMPKINS IN THE BASKETS", 12, 100);

// press spacebar to start
if write_start_text {
  draw_text(room_width/2, room_height - 24, "PRESS SPACE TO START");
}
